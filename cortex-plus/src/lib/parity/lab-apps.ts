...
export const LAB_APPS: LabApp[] = [
  { id: "grafik", title: "Grafik çizici", subject: "Matematik", href: lab("grafik"), category: "sim" },
  ...
  { id: "gunes", title: "Güneş sistemi", subject: "Fizik", href: lab("gunes"), category: "sim" },
  ...
  { id: "periyodik", title: "Periyodik tablo", subject: "Kimya", href: lab("periyodik"), category: "tool" },

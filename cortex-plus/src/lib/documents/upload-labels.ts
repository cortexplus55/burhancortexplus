...
export const DOCUMENT_KIND_LABEL =
  "PDF, Word (.docx), PowerPoint (.pptx), TXT ve görsel";

export const DOCUMENT_UPLOAD_HINT = `${DOCUMENT_KIND_LABEL} · en fazla 15 MB`;

export const DOCUMENT_TYPE_REJECTED =
  "Bu dosya türü desteklenmiyor. PDF, Word (.docx), PowerPoint (.pptx), TXT veya görsel yükle.";

export const DOCUMENT_PICK_REJECTED =
  "PDF, Word (.docx), PowerPoint (.pptx), görsel veya TXT yükleyebilirsin.";

export const DOCUMENT_MATERIAL_HINT =
  "PDF, Word (.docx), PowerPoint (.pptx) ya da görsel yükle; her şey senin belgenden üretilsin.";

  ...
  return (
    <ParitySorShell {...shell}>
      <article className="cp-exam-page cp-lesson-page">
        ...
        <div className="cp-exam-result-divider" aria-hidden />
        <p className="cp-lesson-kicker">{prep.title ?? "Sınav hazırlığı"}</p>
        <h1>{lesson.title}</h1>
        {created ? <p className="cp-lesson-date">{created}</p> : null}

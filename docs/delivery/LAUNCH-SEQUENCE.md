...
| 5 | Kayıt uçtan uca | kayıt → `/email-dogrula` veya `/kayit/tamamla` | **Açık** — gerçek adresle bir kayıt; ajan hesap açamaz. ("Kalan tek adım" değil artık: PostHog ve PayTR de açık — [SENIN-YAPACAKLARIN.md](./SENIN-YAPACAKLARIN.md)) |
...
**PayTR — 16 Eylül 2026'da listeye girdi.** Bu satır uzun süre "bilinçli olarak
bu listede yok, ödeme hazır olunca ayrı faz" diyordu. Ek mağaza onaylandı, kod
tarafı bitti; artık ayrı faz değil, kalan launch işlerinden biri.
Adımlar: [SENIN-YAPACAKLARIN.md](./SENIN-YAPACAKLARIN.md) §8 ·
gerekçeler: [PAYTR-ABONELIK.md](../../cortex-plus/docs/delivery/PAYTR-ABONELIK.md)
